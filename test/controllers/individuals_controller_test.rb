...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { category: @individual.category, notes: @individual.notes, user_id: @individual.user_id }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { category: @individual.category, notes: @individual.notes, user_id: @individual.user_id }
    assert_redirected_to individual_path(assigns(:individual))
  end
